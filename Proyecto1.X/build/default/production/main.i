...
MAIN:
    ...
    bsf TRISB, 2
    bsf TRISB, 3
    bsf TRISB, 4 ; Se configuran ((PORTB) and 07Fh), 0, ((PORTB) and 07Fh), 1, ((PORTB) and 07Fh), 2, ((PORTB) and 07Fh), 3 y ((PORTB) and 07Fh), 4 como inputs
    ...
    bsf WPUB, 2
    bsf WPUB, 3
    bsf WPUB, 4 ; Habilitando los pull-ups en ((PORTB) and 07Fh), 0, ((PORTB) and 07Fh), 1, ((PORTB) and 07Fh), 2, ((PORTB) and 07Fh), 3 y ((PORTB) and 07Fh), 4
